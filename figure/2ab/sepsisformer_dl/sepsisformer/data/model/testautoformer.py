...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, mlp_ratio=3.0, act_layer=nn.GELU, drop_ration=0.2):
        super().__init__()
...
class Model(nn.Module):
    ...
    def __init__(self, factor=1,input_size=36,moving_avg=25,device='cuda:0',
                 seq_len=36,label_len=1,pred_len=2,d_model=36, n_heads=12,
                 dropout=0.05,d_ff=None,activation='gelu',
                 e_layers=5,#循环几次encoder
