...
def main():
    ...
    dir_name = ml_get_dir_name(model_name='Logistic Regression')
    ...
    standard_pyh_test_inputs, pyh_test_labels = ml_get_data(path=r'I:\mimic_transformer\data0\NBL0_382-smote3.csv', logs=logs_name,
