...
def DT_classifier(train_features, train_labels, test_features, test_labels):
    ...
    model = joblib.load('/mnt/public/home/zhijiangwan/sepsisformer/sepsisformer/model2/result/DT.model')
...
def main():
    ...
    standard_pyh_test_inputs, pyh_test_labels = ml_get_data(path=r'/mnt/public/home/zhijiangwan/sepsisformer/sepsisformer/data/36/mimic3_smote_36.csv',
