...
def RF_classifier(train_features, train_labels, test_features, test_labels, n_estimators=5, max_depth=None):
...
def main():
    dir_name = ml_get_dir_name(model_name='Random Forest')
    ...
    standard_pyh_test_inputs, pyh_test_labels = ml_get_data(path=r'I:\mimic_transformer\data0\NBL0_382-smote3.csv',
