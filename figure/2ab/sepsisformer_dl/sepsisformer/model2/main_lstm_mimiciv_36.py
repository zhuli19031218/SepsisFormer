...
def hyperParameters():
    ...
    parser.add_argument('--factors', type=int, default=36,
                        help="输入特征的数量 (因子数)，应与数据匹配。")
    parser.add_argument('--data_path', type=str,
                        default="/mnt/public/home/zhijiangwan/sepsisformer/sepsisformer/data/36/mimic4_smote_36.csv",
                        help="数据集 CSV 文件的路径。")
    parser.add_argument('--lr', type=float, default=5e-4,
                        help='初始学习率。')
    parser.add_argument('--epoch', type=int, default=1200, # 可根据需要调整轮数
                        help='训练的总轮数。')
