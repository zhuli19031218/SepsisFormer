...
def DT_classifier(train_features, train_labels, test_features, test_labels):
    ...
    model = tree.DecisionTreeClassifier(criterion='entropy',splitter="random",max_depth=13)  # 建立逻辑回归模型
    #model = joblib.load(r'F:\sepsisformer\ml\result\DT.model')
 ...
 # mimic4_smote_36
def main():
    dir_name = ml_get_dir_name(model_name='Decision Trees1')
    ...
    standard_pyh_test_inputs, pyh_test_labels = ml_get_data(path=r'F:\sepsisformer\data\8\mimic3_eICU_smote_8.csv',
