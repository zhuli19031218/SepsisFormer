...
def main():
    ...
    dir_name = ml_get_dir_name(model_name='Logistic Regression2')                   
    ...
    standard_pyh_test_inputs, pyh_test_labels = ml_get_data(path=r'F:\sepsisformer\data\8\mimic4_smote_8.csv', logs=logs_name,
