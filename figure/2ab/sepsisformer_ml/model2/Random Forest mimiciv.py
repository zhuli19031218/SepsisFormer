...
def RF_classifier(train_features, train_labels, test_features, test_labels, n_estimators=40, max_depth=None):
...
def main():
    dir_name = ml_get_dir_name(model_name='Random Forest5')
    ...
    standard_pyh_test_inputs, pyh_test_labels = ml_get_data(path=r'F:\sepsisformer\data\36\mimic4_smote_36.csv',
